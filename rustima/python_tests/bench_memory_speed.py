...
사용법 (sarimax_rs/ 디렉토리에서):
  .venv/bin/python python_tests/bench_memory_speed.py
  .venv/bin/python python_tests/bench_memory_speed.py --with-pmdarima
  .venv/bin/python python_tests/bench_memory_speed.py --no-chart
"""
